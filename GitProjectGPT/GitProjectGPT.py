...
os.environ["OPENAI_API_KEY"] = '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'
...
iface = gradio.Interface(fn=chatbot,
                     inputs=gradio.components.Textbox(lines=7, placeholder="Enter your question here"),
                     outputs="text",
                     title="Git Project ChatBot: Your Knowledge Companion Powered-by ChatGPT",
                     description="Ask any question about git project",
